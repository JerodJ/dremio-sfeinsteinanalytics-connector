# CData Dremio ARP Connector for Salesforce Einstein Analytics
...
3. Download and install the [Salesforce Einstein Analytics JDBC Driver from CData](https://www.cdata.com/drivers/einstein/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
